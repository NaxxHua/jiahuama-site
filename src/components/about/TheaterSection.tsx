...
/**
 * Theatre playbill. Standalone it renders its own section + heading; pass
 * `asSubsection` to drop the wrapper so it can sit under another heading
...
export default function TheaterSection({
  ...
  const playbill = (
    <Reveal delay={asSubsection ? 0 : 0.1}>
      <div
        ...
        className={`relative ${
          asSubsection ? "mt-5" : "mt-10"
        } overflow-hidden rounded-xl border border-border bg-panel/70 backdrop-blur-md`}
      >
        {/* Warm spotlight glow */}
        <div
        ...
        <div
          ...
          style={{
            background: "color-mix(in oklab, var(--stage) 9%, transparent)",
          }}
        >
          <p
            ...
            >
              ...
              <div className="relative flex items-start gap-4 px-7 py-6">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-0.5 text-[13px] text-fg-3">{secondary}</p>
  ...
  if (asSubsection) return playbill;
