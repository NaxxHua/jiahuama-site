/**
 * PixelTransition — pixelated dissolve between two states on hover.
 * Ported from React Bits (MIT) — https://reactbits.dev/animations/pixel-transition
 * GSAP-driven; no extra dependency beyond gsap.
 */
