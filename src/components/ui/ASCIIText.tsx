/**
 * ASCIIText — renders text as an animated, mouse-reactive 3D ASCII-art plane.
 * Ported from React Bits (MIT) — https://reactbits.dev/text-animations/ascii-text
 * (originally from https://codepen.io/JuanFuentes/pen/eYEeoyE)
 *
 * Uses three.js. Only imported by the lazy-loaded 404 route, so three.js
 * ships in that route's chunk and never loads on a normal page.
 */
    ...
    >
      <style>{`
        ...
        .ascii-text-container pre {
          ...
          left: 0;
          top: 0;
          background-image: radial-gradient(circle, #4aa3ff 0%, #7fc1ff 50%, #bfe3ff 100%);
