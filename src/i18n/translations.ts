...
const en = {
  ...
  game: {
    ...
    feedback: {
      ...
      intro: "Only a nickname is required — fill in as much or as little as you like.",
      name: "Nickname",
      namePlaceholder: "What should I call you? (required)",
      nameRequired: "Please leave a nickname.",
      submit: "Submit feedback",
      submitting: "Submitting…",
      success: "Got it — thank you so much!",
...
const zh: Dict = {
  ...
  game: {
    ...
    feedback: {
      cta: "有任何反馈？",
      title: "试玩反馈",
      intro: "只有昵称必填，其余想填多少填多少，凭直觉写就行。",
      name: "昵称",
      namePlaceholder: "怎么称呼你？（必填）",
      nameRequired: "留个昵称吧。",
      submit: "提交反馈",
      submitting: "提交中…",
      success: "收到啦——太感谢了！",
