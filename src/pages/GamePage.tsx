...
// 游戏托管地址（Cloudflare R2 自定义域名 game.jiahuama.com）。
// 用自定义域名而非 pub-*.r2.dev：后者是 R2 共享测试域名，被钓鱼活动滥用后遭杀软整段拉黑（URL/FakeCaptcha 误报）。
const GAME_URL_BASE = "https://game.jiahuama.com/index.html";
